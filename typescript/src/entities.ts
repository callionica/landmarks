type EntityData = { codepoints: number[], characters: string };

const entities: { [name: string] : EntityData | undefined; } = {
...
export function getEntity(name: string) : EntityData | undefined {
